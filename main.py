...
SEARCH_USERS = [226098861, 1288551587, 1144271314, 1385605251, 287305832, 1645755515]  # Анна, Яна, Сабина, Катя, Я, Женя
...
1\\.[Изюмка](t\\.me/poisk_izumki)
2\\.[Рута](t\\.me/poiskruty)
...
async def handle_keywords(update: Update, context: ContextTypes.DEFAULT_TYPE) -> bool:
    ...
    # Для чата тестирования (-1003231802185) отключаем обработку ключевых слов
    if chat_id == TESTING_CHAT_ID:
        return False
    
    text = update.message.text.lower()
    
    # Список ключевых слов и их возможных форм (все в нижнем регистре)
    # Поскольку мы приводим весь текст к lower(), это охватывает все варианты написания
    keywords = [
